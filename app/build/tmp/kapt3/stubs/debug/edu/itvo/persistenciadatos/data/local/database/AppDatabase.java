...
@androidx.room.Database(entities = {edu.itvo.persistenciadatos.data.local.database.UserEntity.class, edu.itvo.persistenciadatos.data.local.database.ProductEntity.class}, version = 2, exportSchema = false)
